...
const ReactiveMe = () => {
    return (
        <div>
        <h6>
            <strong><h2 style={{ color: '#2f2fa2' }}>Reactive ME Dyes (Bi-Functional Dyes)</h2></strong>
            <ul>
                <li>Advantage :: Bright Colours, High fastness in washing and Easy shading shading.</li>
                <li>Application :: Exhaust Dyeing (60°C) , Cold-Pad-Batch, Continuous Dyeing.</li>
            </ul>
        </h6>
        <Table className='style1'>
            <tr>
                <TdHeader className="style7" colSpan="3" bgColor="#DEF3FD">
                    <span style={{ fontFamily: 'Bodoni MT', color: '#2f2fa2' }}><strong>SAMEER & SONS</strong></span><br />
                    <br />
                    <span className="style21">MILD EXHAUSTIVE(ME)DYES</span>
                </TdHeader>
                <Td className="style4" align="center" valign="baseline" bgColor="#DEF3FD">
