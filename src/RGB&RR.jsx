...
const RRDDyes = () => {
  return (
    <div>
      <h6>
        <strong>
          <h2 style={{ color: '#2f2fa2' }}>RGB & RR Dyes (Tri-Functional Dyes)</h2>
        </strong>
        <ul>
          <li>Advantage :: Highly Fixation, Good stable in alkali and suitable for light to dark shades.</li>
